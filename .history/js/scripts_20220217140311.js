...
window.addEventListener("load", function () {
  ...
  const silderMain = document.querySelector(".projects_list");
  const silderItems = document.querySelectorAll(".projects_info");
  const nextBtn = document.querySelector(".silder-next");
  const prevBtn = document.querySelector(".silder-prev");
  const dotItems = document.querySelectorAll(".silder-dot-item");
});
...
$(document).ready(function () {
  $(".projects_list").slick({
    ...
    arrows: true,
    draggable: false,
    prevArrow: `<button type='button' class='slick-prev slick-arrow'><i class='fa fa-angle-left silder-prev'></i></button>`,
    nextArrow: `<button type='button' class='slick-next slick-arrow'><i class='fa fa-angle-right silder-next'></i></button>`,
  });
});
