...
$(document).ready(function () {
  $(".projects_list").slick({
    ...
    arrows: true,
    draggable: false,
    prevArrow: `<button type='button' class='slick-prev slick-arrow'><i name="arrow-back-outline"></i></button>`,
    nextArrow: `<button type='button' class='slick-next slick-arrow'><i name="arrow-forward-outline"></i></button>`,
  });
});
